...
export const Slide2: React.FC<{ goSlide: (n: number) => void }> = ({ goSlide }) => (
  <div className="flex flex-col items-center text-center px-4 md:px-6 pt-2 md:pt-3 pb-3 md:pb-4 select-none">
    ...
    <div className="grid grid-cols-3 grid-rows-[auto_auto] gap-4 md:gap-6 w-full max-w-5xl">
      {/* ── 01 Pendahuluan (col-span-2) bento internal 5×5 ── */}
      <button onClick={() => goSlide(items[0].target)}
        className="group col-span-2 bg-white border-2 border-slate-200 hover:border-cardinal rounded-2xl p-4 md:p-5 text-left transition-all duration-200 hover:shadow-lg hover:shadow-cardinal/10 hover:-translate-y-0.5"
      >
        <div className="grid grid-cols-[auto_1fr_auto] gap-x-5 gap-y-1 items-center">
          <div className="row-span-2 flex items-center justify-center h-full py-2">
      ...
      <button onClick={() => goSlide(items[1].target)}
        className="group col-span-1 row-span-2 bg-white border-2 border-slate-200 hover:border-macaw rounded-2xl p-4 md:p-5 text-left transition-all duration-200 hover:shadow-lg hover:shadow-macaw/10 hover:-translate-y-0.5 flex flex-col justify-between"
      >
        <div className="flex flex-col gap-1.5">
          <div className="flex items-start justify-between">
            <NumBadge num={items[1].num} color="text-macaw" />
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-macaw/10 border border-macaw/10 flex items-center justify-center group-hover:bg-macaw/20 transition-colors shrink-0">
              <Puzzle size={22} className="text-macaw" />
            </div>
          </div>
          <h3 className="font-extrabold text-sm md:text-base text-slate-800 mt-1">{items[1].title}</h3>
          <ul className="text-xs md:text-sm text-slate-500 leading-snug space-y-0.5 list-disc list-inside">
            <li>Analysis</li>
            <li>Design</li>
            <li>Development</li>
        ...
        <div className="flex items-center gap-1.5 text-xs font-bold text-macaw mt-2">
          <span>5 tahap</span>
      ...
      <button onClick={() => goSlide(items[2].target)}
        className="group col-span-1 bg-white border-2 border-slate-200 hover:border-feather rounded-2xl p-4 md:p-5 text-left transition-all duration-200 hover:shadow-lg hover:shadow-feather/10 hover:-translate-y-0.5"
      >
        <div className="grid gap-y-2">
          <div className="flex items-center justify-between">
            <NumBadge num={items[2].num} color="text-feather-dark" />
            <IconBox color="text-feather-dark"><Layout size={24} className="text-feather-dark" /></IconBox>
          </div>
      ...
      <button onClick={() => goSlide(items[3].target)}
        className="group col-span-1 bg-white border-2 border-slate-200 hover:border-bee rounded-2xl p-4 md:p-5 text-left transition-all duration-200 hover:shadow-lg hover:shadow-bee/10 hover:-translate-y-0.5"
      >
        <div className="grid gap-y-2">
          <div className="flex items-center justify-between">
            <NumBadge num={items[3].num} color="text-bee-dark" />
            <IconBox color="text-bee-dark"><Bot size={24} className="text-bee-dark" /></IconBox>
          </div>
    ...
    <div className="grid grid-cols-2 gap-4 md:gap-6 w-full max-w-5xl mt-4 md:mt-6">
      {/* ── 05 Hasil Penelitian ── */}
      <button onClick={() => goSlide(items[4].target)}
        className="group bg-white border-2 border-slate-200 hover:border-fox rounded-2xl p-4 md:p-5 text-left transition-all duration-200 hover:shadow-lg hover:shadow-fox/10 hover:-translate-y-0.5"
      >
        <div className="grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-1 items-center">
          ...
          <div className="row-span-2 flex items-center justify-center h-full">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-fox/10 border border-fox/10 flex items-center justify-center group-hover:bg-fox/20 transition-colors">
              <BarChart3 size={22} className="text-fox" />
            </div>
          </div>
        </div>
      </button>
      ...
      <button onClick={() => goSlide(items[5].target)}
        className="group bg-white border-2 border-slate-200 hover:border-feather rounded-2xl p-4 md:p-5 text-left transition-all duration-200 hover:shadow-lg hover:shadow-feather/10 hover:-translate-y-0.5"
      >
        <div className="grid grid-cols-[auto_1fr_auto] gap-x-3 gap-y-1 items-center">
          <div className="row-span-2 flex items-center justify-center h-full py-1">
          ...
          <div className="row-span-2 flex items-center justify-center h-full">
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-feather/10 border border-feather/10 flex items-center justify-center group-hover:bg-feather/20 transition-colors">
              <CheckCircle size={22} className="text-feather-dark" />
            </div>
          </div>
        </div>
      </button>
