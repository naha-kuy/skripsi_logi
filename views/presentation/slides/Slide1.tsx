...
export const Slide1 = () => (
  <div className="flex flex-col items-center justify-center text-center text-white px-4 md:px-8 w-full max-w-5xl h-full select-none">
    <div className="animate-bounce-slow mb-4">
      <div className="w-32 h-32 bg-white/10 backdrop-blur border-2 border-white/20 rounded-full flex items-center justify-center text-5xl shadow-xl overflow-hidden relative">
        <img 
    ...
    <div className="uppercase tracking-widest text-xs md:text-sm font-black text-feather-light mb-3">
      UNIVERSITAS NEGERI MALANG • FAKULTAS MIPA
    </div>
    
    <h1 className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight max-w-5xl text-white font-display mb-6">
