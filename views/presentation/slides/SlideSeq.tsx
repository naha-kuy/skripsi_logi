...
export const SlideSeq: React.FC = () => (
  <div className="flex flex-col items-center text-center px-4 md:px-6 pt-2 md:pt-3 pb-3 md:pb-4 select-none">
    <p className="text-sm font-bold text-feather-dark uppercase tracking-[0.2em] mb-1">Arsitektur Sistem</p>
    ...
    <div className="w-full max-w-5xl">
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <p className="text-xs md:text-sm font-bold text-slate-400">Sequence Diagram Interaksi Komponen</p>
          <p className="text-xs md:text-sm text-slate-400">3002 x 2620 px</p>
        </div>
      </SlideImage>
    </div>
  </div>
